        ...
        <div className="relative flex flex-col items-center">
          <div
            className={`rounded-full transition duration-500 ease-in-out border-2 border-gray-300 h-12 w-12 flex items-center justify-center py-3 ${
              step.selected ? "bg-primary text-white font-bold" : ""
            }`}
          >
            {step.completed ? (
          ...
          <div
            className={`absolute top-0 text-center mt-16 w-32 text-xs font-semibold tracking-wide uppercase duration-500 transition-all ease-in-out ${
